...
const DatosEmpresa = ({ children, className, socio }) => {
    ...
    return (
        ...
        <div className="md:w-3/5 sm:w-full md:h-full">

            <FlexBox>

                <div className="md:flex justify-start gap-6 pb-2 border-b-2 border-[#f4eeee]">

                    <div>
                        <img
                            src={`http://01-servidor/react_back/archivos/socio_fotos/${socio_Emp_Logo}`}
                            alt="Logo empresa socio"
                            className="rounded-md mb-4 m-auto w-100 md:max-w-[280px]"
                        />
                    </div>
                    <div>

                        <h3 className="mb-2 tracking-normal">{socio_Emp_Nombre}</h3>
                        ...
                        <ul className="font-medium tracking-normal my-2 text-sm">
                            ...
                            <li className="mb-1 flex justify-start items-center">
                                ...
                                <Link href={`tel:0034${socio_Emp_Telefono}`} className="text-[#181c32] hover:text-[#d6d6d6] ml-2"><span className="">{socio_Emp_Telefono}</span></Link>

                            </li>
                            <li className="mb-1 flex justify-start items-center">

                                <HiMiniEnvelope className="h-5 w-5 text-[#d0a53d]" />
                                <Link href={`mailto:${socio_Emp_Email}`} className="text-[#181c32] hover:text-[#d6d6d6] ml-2"><span className="">{socio_Emp_Email}</span></Link>
                        ...
                        <div className="mb-1 flex  justify-start items-center">

                            {
                                ...
                                (<Link href={`${socio_Emp_Perfil_Linkedin}`}>
                                    <svg
...

                            {
                                ...
                                (<Link href={`${socio_Emp_Perfil_Facebook}`}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="#1877F2"
                                        className="h-5 w-5"
...

                            {
                                ...
                                (<Link href={`${socio_Emp_Perfil_Instagram}`}>
                ...
                <div className="flex flex-col mt-2">
                    ...
                    <h3 className="my-3 tracking-normal font-semibold text-lg">Descripción de la empresa</h3>

                    <p className="tracking-normal text-sm text-[#64748b] whitespace-pre-line">
                        {ReactHtmlParser(socio_Emp_Descripcion)}
                    </p>
